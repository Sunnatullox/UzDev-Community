...
import "../../style/NodFound.scss";
import { Link } from "react-router-dom";
import notfound from '../../image/71229-not-found.svg'
...
<div className="container notfounds">
	<div className="left-section">
		<div className="inner-content">
			<h1 className="headings text-white f-left d-flex">Nod Found Posts</h1>
			{/* <p className="subheading">Looks like the page you were looking for is no longer here.</p> */}
		<Link to="/createpost" style={{"marginLeft":"11rem"}} className="btn mt-5 fs-100">Add Post</Link>
    </div>
	</div>
	<div className="right-section">
  <svg className="svgimg" style={{flout:"left"}} xmlns="http://www.w3.org/2000/svg" viewBox="51.5 -15.288 385 505.565">
        ...
        <g id="lamp">
          ...
          <radialGradient className="light-gradient" id="SVGID_1_" cx="119.676" cy="44.22" r="65" gradientUnits="userSpaceOnUse">
            ...
            <stop  offset="30%" stopColor={'#EDEDED'} stopOpacity={0.1}>
      ...
      {/* <div className="view introcontainerimg">
          ...
          <div className="container px-md-3 px-sm-0">
            <div className="row wow fadeIn">
              <div className="col-md-12 mb-4 white-text text-center wow fadeIn">
                ...
                <hr className="hr-light   bg-white" />
